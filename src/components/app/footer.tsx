...
export const Footer = () => (
  <footer className="bg-teal-950 text-teal-400 py-12 px-6 md:px-12">
    <div className="container mx-auto">
      <div className="grid md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-teal-300 text-sm">
            Patient-first data-driven platform helping you help yourself.
          </p>
        </div>
      ...
      <div className="border-t border-teal-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p className="text-teal-400 text-sm mb-4 md:mb-0">
          © {new Date().getFullYear()} Health.Navigator. All rights reserved.
        </p>
